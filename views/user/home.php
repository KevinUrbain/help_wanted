...
<body>
    ...
    <main class="main-home">
        ...
        <section class="hero">
            ...
            <p>Partagez, demandez, offrez. Ensemble, faisons vivre l'entraide de proximité.</p>
        </section>

        <!-- Filter tabs -->
        <div class="filter-tabs">
            <button class="tab active" onclick="filterCards('all')">Tout voir</button>
            <button class="tab" onclick="filterCards('demande')">Demandes d'aide</button>
            <button class="tab" onclick="filterCards('offre')">Offres de service</button>
        </div>
        ...
        <div class="cards-grid" id="cardsContainer">
            ...
            <div class="card" data-type="demande">
                ...
                <h3><a href="" class="links">Besoin d'aide pour déménager un canapé</a></h3>
                <p>Bonjour ! Je cherche quelqu'un avec un van pour m'aider à déplacer un canapé 3 places du
                    rez-de-chaussée. Distance : 5 km environ.</p>
            ...
            <div class="card" data-type="offre">
                ...
                <h3><a href="" class="links">Cours de guitare gratuits pour débutants</a></h3>
                <p>Guitariste depuis 15 ans, je propose des cours gratuits les samedis après-midi. Tous niveaux
                    bienvenus, dans une ambiance détendue !</p>
                <div class="card-footer">
                    <div class="card-meta">
                        <div class="card-author">
